...
def search():
	...
	if request.method == 'POST':
		...
		if 'secureSearch' in request.form:
			...
			# mercariList = get_items(mpn, ebayinfo['AvgPrice']*0.3, ebayinfo['AvgPrice'])
		else:
			print(request.form)
			...
			# mercariList = get_items(newname, ebayinfo['AvgPrice']*0.3, ebayinfo['AvgPrice'])

		# for item in mercariList:
		# 	mercariNames.append(item['name'])
		# 	mercari-images.append(item['image'])
